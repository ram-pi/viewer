...
var jarLocationUploader = __parentDir + "/utils/NiftiDBUploader.jar";
...
exports.loadIntoDB = function(filename) {
	var directory = __parentDir + "/images/Segmentation";
	var command = "/usr/bin/java -jar " + jarLocationUploader + " " + directory + " " + filename;
	console.log("CREATOR: " + command);
	child = exec(command, function(err, result) {
		console.log("IMAGECREATOR: UPLOAD INTO DB DONE");
	});
}
